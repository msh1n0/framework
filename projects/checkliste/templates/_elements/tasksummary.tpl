            ...
            <tr>
                ...
                <td class="text-right">
                    ...
                    {if $task['finish_status']!=1 && $task['finish_status']!=2 && $mode!='own'}
                        <a href="{$page}?site=tasks_take&id={$task['id']}"><span class="glyphicon glyphicon-save" title="Aufgabe annehmen"></span></a>&nbsp;&nbsp;
                    {/if}
                    {if $task['finish_status']!=1 && $task['finish_status']!=2 && $mode=='own'}
                        <a href="{$page}?site=tasks_resign&task={$task['id']}&user={$user['id']}&fromsite=statistics"><span class="glyphicon glyphicon-export" title="Aufgabe abweisen"></span></a>&nbsp;&nbsp;
                    {/if}
