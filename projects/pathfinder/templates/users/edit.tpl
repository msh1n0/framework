...
{block name=content}
    <div class="alert alert-info">
        ...
        <div class="form-group">
            <label for="tp">Kampfphasenwürfel w4:</label>
            <input type="text" name="user[cw4]" id="tp" value="{$user['cw4']}" class="form-control">
        </div>
        <div class="form-group">
            <label for="tp">Kampfphasenwürfel w6:</label>
            <input type="text" name="user[cw6]" id="tp" value="{$user['cw6']}" class="form-control">
        </div>
        <div class="form-group">
            <label for="tp">Kampfphasenwürfel w8:</label>
            <input type="text" name="user[cw8]" id="tp" value="{$user['cw8']}" class="form-control">
        </div>
        <div class="form-group">
            <label for="tp">Kampfphasenwürfel w10:</label>
            <input type="text" name="user[cw10]" id="tp" value="{$user['cw10']}" class="form-control">
        </div>
        <div class="form-group">
            <label for="tp">Kampfphasenwürfel w12:</label>
            <input type="text" name="user[cw12]" id="tp" value="{$user['cw12']}" class="form-control">
        </div>
        <div class="form-group">
            <label for="tp">Kampfphasenwürfel w20:</label>
            <input type="text" name="user[cw20]" id="tp" value="{$user['cw20']}" class="form-control">
        </div>
        <div class="form-group">
            <label for="tp">Kampfphasenwürfel w100:</label>
            <input type="text" name="user[cw100]" id="tp" value="{$user['cw100']}" class="form-control">
        </div>
        <div class="form-group">
