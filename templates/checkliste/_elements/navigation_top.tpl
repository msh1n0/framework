                ...
                {if $isLoggedIn}
                    <li><a data-toggle="dropdown" href="#">Aufgaben</a>
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                            <li><a href="{$page}?site=statistics"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;Meine Aufgaben</a></li>
                            <li><a href="{$page}?site=tasks_summary&filter=finish_status&value=0&mode=group"><span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;offene Aufgaben</a></li>
